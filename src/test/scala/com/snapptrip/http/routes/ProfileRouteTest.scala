package com.snapptrip.http.routes
...
import com.snapptrip.restapi.core.{AuthTokenContent, UserProfile, UserProfileUpdate}
import com.snapptrip.restapi.core.profiles.UserProfileService
import com.snapptrip.restapi.http.routes.ProfileRoute
